const I18N = {
  ja: {
    ...
    'violations.notEnoughMembersCombined': '{date}の合同日メンバーが不足（{count}名のみ）',
  ...
  en: {
    ...
    replace: 'Replace',
    confirm: 'Confirm',
    candidateRecommended: 'Candidates',
    candidateNonRecommended: 'Not recommended',
    disableInputAssist: 'Disable input assist',
    ...
    'violations.notEnoughMembersCombined': 'Not enough members for combined day {date} ({count} available)',
